...
public class BackUpOrderDetailEntity {
	...
	public BackUpOrderDetailEntity() {
		super();
	}

	public BackUpOrderDetailEntity(long partyId, String partyName, long itemId, String itemName, long itemDetailId, String detailName,
			Integer xsmall, Integer small, Integer medium, Integer large,
			Integer xlarge, Integer xxlarge, Integer xxxlarge, Integer mix,
			Integer detailTotalQuantity) {
		super();
	...
	public String toString() {
		return "BackUpOrderDetailEntity [orderDetailId=" + orderDetailId
