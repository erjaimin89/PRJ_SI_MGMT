...
public class ItemSalesDetailDialog extends JDialog {
    private static final long serialVersionUID = -544195604082198342L;
    ...
    public ItemSalesDetailDialog(Frame parent) {
        super(parent);
        ...
        setTitle("Item Sales Details Report");
        setSize(600, 300);
        ...
        btnUpdateOrder.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedIndex <= 0) {
                    ...
                    map.put("fromDate", 0l);
                    map.put("toDate", 0l);
                    sb.append("  sims.SALES_ORDERS_DETAILS.`PARTY_ID` = " + selectedParty.getKey());
                    if (fromDate != null) {
                    ...
                    if (selectedItem.getKey() > 0) {
                        sb.append(" and sims.SALES_ORDERS_DETAILS.`ITEM_ID` = " + selectedItem.getKey());
                    }
                    sb.append(" ");
                    ...
                    try {
                        if (selectedItem.getKey() > 0) {
                            jpPrint = JasperFillManager.fillReport(
                                    Utils.getReportJasperName("ItemSalesReport2.jasper"), map,
                                    hibernate.Database.getConnection());
                        } else {
                            jpPrint = JasperFillManager.fillReport(
                                    Utils.getReportJasperName("ItemSalesReport1.jasper"), map,
                                    hibernate.Database.getConnection());
                        }
