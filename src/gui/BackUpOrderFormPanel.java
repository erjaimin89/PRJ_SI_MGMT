...
public class BackUpOrderFormPanel extends JPanel {
    ...
    public BackUpOrderFormPanel() {
        ...
        setBorder(new TitledBorder(null, "BackUp Order", TitledBorder.CENTER, TitledBorder.TOP, new Font("Tahoma",
                Font.BOLD, 14), new Color(34, 139, 34)));
    ...
    private void setLayoutComponents() {
        ...
        noteField.setBorder(new LineBorder(UIManager.getColor("TextArea.inactiveForeground")));
        noteField.setRows(3);
        ...
        btnSaveProduct.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (partyCombo.getSelectedIndex() <= 0) {
                    ...
                    boolean generateBackUpOrder = manageBackUpOrders.generateBackUpOrder((ComboItem) partyCombo
                            .getSelectedItem(),
                            (itemcombo.getSelectedIndex() > 0) ? (ComboItem) itemcombo.getSelectedItem() : null,
