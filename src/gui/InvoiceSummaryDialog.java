...
public class InvoiceSummaryDialog extends JDialog {
    private static final long serialVersionUID = 4131900026346573099L;
    private JDatePickerImpl datePickerFrom;
    private JDatePickerImpl datePickerTo;

    public InvoiceSummaryDialog(Frame parent) {
        super(parent);
        ...
        setTitle("Invoice Summary Report");
        setSize(400, 200);
    ...
    private void createLayout() {
        ...
        JLabel lblOrderDate = new JLabel("Invoice Date :");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if ((fromDate != null) && (toDate != null) && fromDate.after(toDate)) {
                    ...
                    if (fromDate != null) {
                        ...
                        sb.append(" and sims.INVOICES.INVOICE_DATE >= " + cal.getTimeInMillis());
                    }
                    if (toDate != null) {
                        cal.setTime(toDate);
                        cal.set(Calendar.HOUR_OF_DAY, 0);
                    ...
                    try {
                        jpPrint = JasperFillManager.fillReport(Utils.getReportJasperName("InvoiceSummary.jasper"), map,
